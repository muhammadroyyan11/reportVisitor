...
class Base_model extends CI_Model
{
    ...
    {   
        $this->db->select('user.nama as nama_lengkap, user.username, user.is_active, user.email, user.id_user, user.role, wisata.nama');
        $this->db->from('user');
        $this->db->join('wisata', 'wisata.id_wisata = user.wisata_id');
